...
let todoItemsStorage = JSON.parse(localStorage.getItem('item')) || [ , ["Jog around the park 3x", false], ["10 minute meditation", false], ["Read for 1 hour", false], ["Pick up groceries", false]
];
